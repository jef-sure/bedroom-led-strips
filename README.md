...
Крепления для профилей было решено крепить к потолку, поскольку было обоснованное предположение, что в одной из стен прямо под потолком идёт проводка.

<p><img alt="Крепление" src="mounting-clip.jpg" width="604" height="545" /></p>

Профиль просто вставляется в это крепление и защёлкивается. 

Свет идёт по трём стенам, распределение сегментов такое: 3м, 2,80м, 3м. Средний сегмент на стене с окном. 
Боковые сегменты не целиком во всю стену, с той стороны шкаф и там над ним света не надо. Сегменты соединяются уголками.

Сегменты светодиодной ленты соединяются коннекторами.

<p><img alt="Коннекторы" src="wires-connectors.jpg" width="527" height="600" /></p>

### Сборка

Первый тест первого сегмента на 3 метра. 

<p><img alt="Первый тест" src="led-first-test.jpg" width="800" height="399" /></p>

Тут видно как параллельный провод уходит внутрь профиля, чтобы дойти до противоположного конца и там снова соединиться с лентой.

<p><img alt="Первый тест" src="alu-wires.jpg" width="600" height="319" /></p>

Все сегменты в сборе.

<p><img alt="Все сегменты" src="all-segments.jpg" width="800" height="183" /></p>

Магически все сегменты были установлены в крепления и закрыты рассеивателями, подключен блок питания и контроллер освещённости.

<p><img alt="Готово!" src="everything-is-ok.jpg" width="800" height="450" /></p>

## Обратная связь

Обсудить, задать вопросы можно в [issues](https://github.com/jef-sure/bedroom-led-strips/issues).
